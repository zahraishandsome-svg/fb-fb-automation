...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Facebook → Facebook Page Automation Runner",
    ...
    if args.summary_only:
        logger.info("FB→Facebook Automation | Summary Only")
    else:
        logger.info("FB→Facebook Automation | Slot %d | dry_run=%s", args.slot, args.dry_run)
    logger.info("=" * 60)
